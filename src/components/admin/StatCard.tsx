...
export function StatCard({ title, value, icon, trend }: StatCardProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col gap-4 relative overflow-hidden group hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start">
        <div className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center text-gray-500 group-hover:bg-[#FF3F6C]/10 group-hover:text-[#FF3F6C] transition-colors">
          {icon}
        </div>
      </div>
      <div>
