  ...
  return (
    <div className="mt-16">
      <div className="flex justify-between items-end mb-6">
        <div>
          <h2 className="text-2xl font-bold font-['Poppins'] text-[#1A1A1A]">Similar Properties</h2>
          <p className="text-gray-500 text-sm mt-1">Properties you might like in {currentLocality}</p>
        </div>
        <button className="text-[#FF3F6C] font-bold text-sm flex items-center gap-1 hover:underline">
