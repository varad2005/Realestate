    ...
    <PageWrapper>
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h1 className="text-4xl md:text-5xl font-black font-['Poppins'] text-[#1A1A1A] leading-tight mb-6">
          Trending <span className="text-[#FF3F6C]">Localities</span>
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
        <div className="space-y-6">
          <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
            <h3 className="text-xl font-bold font-['Poppins'] mb-6 flex items-center gap-2">
              <TrendingUp className="text-[#FF3F6C]" /> Top Rising Areas
            </h3>
            <div className="space-y-4">
              {loading ? (
                ...
                <div key={loc.id} className="flex items-center justify-between p-4 rounded-xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100 cursor-pointer">
                  <div className="flex items-center gap-4">
                    <div className="text-2xl font-black text-gray-200">0{i+1}</div>
                    <div>
                      <p className="font-bold text-[#1A1A1A] text-lg">{loc.name} <span className="text-xs font-normal text-gray-500 ml-1">({loc.city})</span></p>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Growth YoY</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 rounded-3xl p-8 h-full border border-blue-100 relative overflow-hidden">
            <div className="absolute -right-10 -bottom-10 opacity-10">
              <MapPin size={300} />
            </div>
            <div className="relative z-10">
              <h3 className="text-xl font-bold font-['Poppins'] text-blue-900 mb-4">Explore by Vibe</h3>
