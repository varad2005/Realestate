...
export function CommercialPage() {
  ...
  return (
    <PageWrapper>
      <div className="bg-gradient-to-r from-muted to-muted rounded-[2.5rem] p-12 text-white mb-16 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl">
          <span className="bg-indigo-600/20 text-indigo-600/60 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest backdrop-blur-sm mb-6 inline-block border border-secondary/80/30">
            For Businesses
          </span>
          <h1 className="text-4xl md:text-5xl font-black font-['Poppins'] leading-tight mb-6">
            Find the Perfect Space for Your Business
          </h1>
          <p className="text-gray-500/50 text-lg mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <div key={i} className="bg-white/10 backdrop-blur-md rounded-xl p-4 flex flex-col items-center justify-center gap-2 border border-white/5 hover:bg-white/20 transition-colors cursor-pointer">
                <amenity.icon size={24} className="text-indigo-600/80" />
