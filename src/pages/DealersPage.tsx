    ...
    <PageWrapper>
      <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
        <div className="flex-1 space-y-8">
          <div className="inline-block bg-[#6C63FF]/10 text-[#6C63FF] font-bold px-4 py-1.5 rounded-full text-xs uppercase tracking-widest">
            For Dealers & Builders
          </div>
          <h1 className="text-4xl md:text-5xl font-black font-['Poppins'] text-[#1A1A1A] leading-tight">
          ...
          <div className="flex gap-4">
            ...
            <button className="bg-white text-[#1A1A1A] border border-gray-200 px-8 py-3.5 rounded-xl font-bold hover:border-gray-400 transition-colors">
              Talk to Sales
            </button>
          </div>
        </div>
        <div className="flex-1 w-full relative">
          ...
          {/* Dashboard mock UI */}
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-6 overflow-hidden relative">
            <div className="flex items-center justify-between border-b border-gray-100 pb-4 mb-6">
              ...
              <div className="bg-emerald-50 text-emerald-600 text-xs font-bold px-3 py-1 rounded-full">
                Active
              </div>
            </div>
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center justify-between p-3 border border-gray-100 rounded-lg">
                    ...
                    <div className="text-xs text-[#FF3F6C] font-bold bg-[#FF3F6C]/10 px-2 py-1 rounded">
                      Hot Lead
                    </div>
                  </div>
                ))}
      ...
      <div className="mb-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold font-['Poppins'] text-[#1A1A1A] mb-4">Powerful Features</h2>
          <p className="text-gray-600">Everything you need to scale your real estate business.</p>
        </div>
